<template>
   ...
   <div class="lg:mb-32 md:mb-20 mb-15">
      ...
      >
         <div
            class="text-white align-cener bg-no-repeat bg-scroll bg-center bg-cover md:pt-14 md:pb-12 md:px-12 sm:py-14 sm:px-6 py-14 px-10 h-460 pl-15"
            :style="{ backgroundImage: `url(${service.videoBannerBg})` }"
         ...
         >
            ...
            <div class="block" :class="service.contentposition">
               <h3
                  class="text-white font-exo text-xl md:text-3xl font-bold uppercase mb-4"
               >
                  {{ service.live }}
               </h3>
               <span class="text-white">
                  ...
                  <a
                     :href="service.linkOnehref"
                     class="block mb-2 last:mb-0 text-lg transition-all hover:text-primary"
                     >{{ service.linkOne }}</a
                  >
                  <a
                     :href="service.linkTwohref"
                     class="block mb-2 last:mb-0 text-lg transition-all hover:text-primary"
                     >{{ service.linkTwo }}</a
                  >
                  <a
                     :href="service.linkThreehref"
                     class="block mb-2 last:mb-0 text-lg transition-all hover:text-primary"
                     >{{ service.linkThree }}</a
                  >
               </span>
         ...
         services: [
            {
               ...
               linkThreehref: 'mailto:cedric.gavage@student.hepl.be',
               linkThree: 'cedric.gavage@student.hepl.be',
            },
            {
            ...
            },
            {
               ...
               linkTwo: '+32 494 79 99 88',
               linkThreehref: 'tel:+32 494 65 63 78',
               linkThree: '+32 494 65 63 78',
            },
         ],
      };
   },
